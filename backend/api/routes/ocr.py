...
Wraps the existing start.py logic as a FastAPI endpoint.
"""
...
async def run_ocr(file: UploadFile = File(...)) -> OcrResponse:
    ...
    """
    try:
        # Import OCR functions from start.py
        from backend.start import process_pdf_to_spatial_text, parse_text_to_json
        ...
        try:
            ...
            # Convert to BiomarkerResult objects
            biomarkers = []
            ...
            # Calculate confidence based on how many biomarkers were extracted
